...
/*-----( Declare objects )-----*/
IPAddress arduinoIp(192,168,137, 185);
...
//    client.println("POST /propertymonitor/api/sensorreadings HTTP/1.1");
    ...
    client.println("Host: 192.168.137.185"); // or generate from your server variable to not hardwire
