...
class SensorTest {
    ...
    void findMinReadingIndex1() {
        assertEquals(86, this.sensor.findMinReadingIndex(84,95));
    }

    @Test
    void findMaxReadingIndex1() {
        assertEquals(13, this.sensor.findMaxReadingIndex(8, 18));
    }

    @org.junit.jupiter.api.Test
    void findMinReadingIndex2() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMinReadingIndex(84,1000));
    }

    @org.junit.jupiter.api.Test
    void findMinReadingIndex3() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMinReadingIndex(-1,117));
    }

    @org.junit.jupiter.api.Test
    void findMinReadingIndex4() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMinReadingIndex(118,85));
    }

    @org.junit.jupiter.api.Test
    void findMinReadingIndex5() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMinReadingIndex(85,-1));
    }

    @Test
    void findMaxReadingIndex2() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMaxReadingIndex(85,1000));
    }

    @Test
    void findMaxReadingIndex3() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMaxReadingIndex(-1,99));
    }

    @Test
    void findMaxReadingIndex4() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMaxReadingIndex(118,10));
    }

    @Test
    void findMaxReadingIndex5() {
        assertThrows(IndexOutOfBoundsException.class, () -> this.sensor.findMaxReadingIndex(25,-1));
    }
    ...
    void findNextCycleMinIndex() {
        assertEquals(8, this.sensor.findNextCycleMinIndex(5));
    }
