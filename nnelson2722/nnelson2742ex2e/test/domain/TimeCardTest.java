...
class TimeCardTest {
    ...
    void copy() {
        ...
        assertEquals(this.timeCard,timeCard1);

    }

    @Test
    void calcHours() {
        assertEquals(10.00,this.timeCard.calcHours());
    }
    ...
    void startTimeEqualsEndTimeTest() {
        assertThrows(TimeCardIllegalArgumentException.class, ()->new TimeCard(LocalDateTime.of(2018,10,22,8,0),LocalDateTime.of(2018,10,22,8,0)));
    }

    @Test
    void startTimeAfterEndTimeTest() {
        assertThrows(TimeCardIllegalArgumentException.class, ()->new TimeCard(LocalDateTime.of(2018,10,22,10,0),LocalDateTime.of(2018,10,22,8,0)));
    }
