...
class HourlyAdministratorTest {
    ...
    @BeforeEach
    void setUp() {
        this.hourlyAdmin = new HourlyAdministrator(105, "Kalis", "Mark", "mark.kalis", LocalDateTime.of(1958,6,8,0,0,0,0), "555-55-5555", "555-555-5555", LocalDateTime.of(1980,8,1,0,0,0), 50.00);
    }
    ...
    void jsonStringifyTest() {
        ...
        assertEquals("{\n" +
                ...
                "\"ssn\":\"555-55-5555\",\n" +
                "\"phone\":\"555-555-5555\",\n" +
                "\"employmentStartDate\":\"1980/08/01\",\n" +
                "\"hourlyRate\":50.0,\n" +
                "\"timeCards\":[\n" +
