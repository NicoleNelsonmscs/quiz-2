...
public class Main {
    public static void main(String[] args){
        ...
        invoice1.addLineItem(new LineItem(1.0,"item 1" ));
        invoice1.addLineItem(new LineItem(2.0,"item 2" ));
        invoice1.addLineItem(new LineItem(3.0,"item 3" ));
        invoice1.addLineItem(new LineItem(4.0,"item 4" ));
