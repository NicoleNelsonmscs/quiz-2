...
public class DbContext {
    ...
    public static ArrayList<Person> getPeople(){
        ...
        persons.add(new Person(101,"Nicole","Nelson","nicole.nelson"));
        persons.add(new Person(102,"Perry","Nelson","perry.nelson"));
        persons.add(new Person(103,"Jay","Dureske","jay.dureske"));
        persons.add(new Person(104,"Gary","Sarcia","gary.sarcia"));
        persons.add(new Person(105,"Juan","Rodriguez","juan.rodriguez"));
        return persons;
    }
}