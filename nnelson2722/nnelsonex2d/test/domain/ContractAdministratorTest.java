...
class ContractAdministratorTest {
    ...
    @BeforeEach
    void setUp() {
        this.contractAdmin = new ContractAdministrator(104, "Baker", "Fred", "fred.baker", LocalDateTime.of(1987,12,14,0,0,0,0), "444-44-4444", "444-444-4444", LocalDateTime.of(2020,4,10,0,0,0,0), 400.0);
    }
